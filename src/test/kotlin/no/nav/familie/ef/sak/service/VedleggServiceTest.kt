...
internal class VedleggServiceTest {
    ...
    private val søknadsdokument = DokumentInfo(dokumentInfoId = "111",
    ...
    private val syktBarnDokument = DokumentInfo(dokumentInfoId = "222",
                                                tittel = "Sykt barn",
                                                dokumentvarianter = listOf(Dokumentvariant(filnavn = "FilnavnDok2",
                                                                                   variantformat = Dokumentvariantformat.ARKIV)))

    private val ukjentDokument = DokumentInfo(dokumentInfoId = "404",
                                              tittel = "Ukjent tittel",
                                              dokumentvarianter = null)

    private val samboerdokument = DokumentInfo(dokumentInfoId = "333",
                                               tittel = "Samboerkontrakt",
                                               brevkode = DokumentBrevkode.OVERGANGSSTØNAD.verdi,
                                               dokumentvarianter = listOf(Dokumentvariant(filnavn = "FilnavnDok3",
                                                                                  variantformat = Dokumentvariantformat.ARKIV)))
    private val skilsmissedokument = DokumentInfo(dokumentInfoId = "444",
                                                  tittel = "Skilsmissepapirer",
                                                  dokumentvarianter =
                                          listOf(Dokumentvariant(filnavn = "FilnavnDok4",
                                                                 variantformat = Dokumentvariantformat.ARKIV)))

    private val journalpostSøknad = Journalpost(journalpostId = "1",
                                                journalposttype = Journalposttype.I,
                                                journalstatus = Journalstatus.MOTTATT,
                                                dokumenter = listOf(søknadsdokument, syktBarnDokument, ukjentDokument)
    )

    private val journalpostEttersendelse = Journalpost(journalpostId = "2",
                                                       journalposttype = Journalposttype.I,
                                                       journalstatus = Journalstatus.MOTTATT,
