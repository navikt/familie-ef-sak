...
internal class VedtaksbrevServiceTest {
    ...
    fun `skal kaste feil hvis saksbehandlerHtml ikke inneholder placeholder for besluttersignatur`(){
        ...
        val feilmelding = assertThrows<Feil> { vedtaksbrevService.lagBeslutterBrev(behandling.id) }.message
    ...
    fun `Skal lage pdf gitt html fra familie-brev`(){
        ...
        vedtaksbrevService.lagSaksbehandlerSanitybrev(behandling.id, objectMapper.createObjectNode(), "brevmal")
