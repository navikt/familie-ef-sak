...
internal class GrunnbeløpstestTest {
    ...
    internal fun `skal sette riktig startdato og sluttdato når beløpsperioder går over flere grunnbeløpsperioder`() {
        ...
        perioder.forEachIndexed { index, beløpsperiode ->
            if (perioder.size > index + 1) {
                assertThat(beløpsperiode.fellesperiode.tom).isBefore(perioder[index + 1].fellesperiode.fom)
            }
        }
    }
    ...
    internal fun `skal sette riktig startdato og sluttdato når beløpsperioder stanser på en g-endringsperiode`() {
        ...
        assertThat(perioder.first().fellesperiode.tom).isEqualTo(LocalDate.of(2021, 4, 30))
        assertThat(perioder.last().fellesperiode.fom).isEqualTo(LocalDate.of(2021, 5, 1))
        assertThat(perioder.last().fellesperiode.tom).isEqualTo(LocalDate.of(2021, 5, 31))
    }
    ...
    internal fun `skal sette riktig startdato og sluttdato når beløpsperioder starter på en g-endringsperiode`() {
        ...
        assertThat(perioder.first().fellesperiode.fom).isEqualTo(LocalDate.of(2021, 5, 1))
        assertThat(perioder.first().fellesperiode.tom).isEqualTo(LocalDate.of(2021, 8, 31))
    }
    ...
    internal fun `skal sette riktig startdato og sluttdato når beløpsperioder starter dagen før en en g-endringsperiode`() {
        ...
        assertThat(perioder.size).isEqualTo(2)
        assertThat(perioder.first().fellesperiode.fom).isEqualTo(LocalDate.of(2021, 4, 1))
        assertThat(perioder.first().fellesperiode.tom).isEqualTo(LocalDate.of(2021, 4, 30))
        assertThat(perioder.last().fellesperiode.fom).isEqualTo(LocalDate.of(2021, 5, 1))
        assertThat(perioder.last().fellesperiode.tom).isEqualTo(LocalDate.of(2021, 8, 31))
    }
}
