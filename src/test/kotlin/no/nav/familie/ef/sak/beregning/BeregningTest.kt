...
internal class BeregningTest {
    ...
    fun `skal finne grunnbeløp mellom perioder`(): List<DynamicTest> {
        val testData = listOf(
                Pair("2000-01-01", "2005-01-01") to listOf(Triple("2000-01-01", "2000-04-30", 46950),
                ...
                Pair("2020-04-30", "2020-05-01") to listOf(Triple("2020-04-30", "2020-04-30", 99858),
                                                           Triple("2020-05-01", "2020-05-01", 101351)),

                Pair("2019-05-01", "2020-05-01") to listOf(Triple("2019-05-01", "2020-04-30", 99858),
                                                           Triple("2020-05-01", "2020-05-01", 101351)),
