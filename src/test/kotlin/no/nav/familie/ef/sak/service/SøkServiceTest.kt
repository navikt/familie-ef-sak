...
internal class SøkServiceTest {
    ...
    private val søkService = SøkService(fagsakRepository, personService, pdlSaksbehandlerClient, adresseMapper)
    ...
    fun `skal finne personIdent, navn og adresse gitt bostedsadresse`() {
        ...
        every {
            pdlSaksbehandlerClient.sokPersoner(any())
        ...
        Assertions.assertThat(søkService.søkPerson(BostedsadresseDto(vegadresse, null))).isEqualTo(person)
    }
}