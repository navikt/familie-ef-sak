    ...
    inner class SkoleårTest {
        ...
        internal fun `skal mappe alle måneder fra juli til samme år`() {
            ...
            IntRange(7, 12).map { fraMåned ->
                ...
                IntRange(fraMåned, 12).forEach { tilMåned ->
                    assertThat(Skoleår(Periode(fra, YearMonth.of(år, tilMåned)))).isEqualTo(skoleår2021)
                }
                IntRange(1, 6).forEach { tilMåned ->
                    assertThat(Skoleår(Periode(fra, YearMonth.of(år + 1, tilMåned)))).isEqualTo(skoleår2021)
                }
            }
        }
        ...
        internal fun `kan ikke ha tildato før fradato`() {
            assertThatThrownBy {
                ...
                Skoleår(Periode(fra, fra.minusMonths(1)))
            }.hasMessage("Til-og-med før fra-og-med: 2021-07-01 > 2021-06-30")
        }
        ...
        internal fun `fradato etter juni må ha tildato før september`() {
            ...
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 7), YearMonth.of(2022, 9))) }
                .hasMessage(feilmelding)
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 7), YearMonth.of(2022, 12))) }
                .hasMessage(feilmelding)
        }

        @Test
        internal fun `fradato etter juni må ha tildato i neste år`() {
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 8), YearMonth.of(2023, 1))) }
        ...
        internal fun `fradato før juli må ha sluttmåned før september`() {
            ...
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 6), YearMonth.of(2021, 9))) }
                .hasMessage(feilmelding)
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 6), YearMonth.of(2021, 12))) }
                .hasMessage(feilmelding)
        }
        ...
        internal fun `fradato før juli med må ha tildato i samme år`() {
            ...
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 6), YearMonth.of(2022, 1))) }
                .hasMessage(feilmelding)
            assertThatThrownBy { Skoleår(Periode(YearMonth.of(2021, 6), YearMonth.of(2022, 2))) }
                .hasMessage(feilmelding)
        }
