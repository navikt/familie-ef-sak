...
Egenskap: Skolepenger med revurdering
  ...
  Scenario: Revurdert med ett nytt beløp i den samme måneden som tidligere
    ...
    Gitt følgende vedtak for skolepenger
      ...
      | 2            | INNVILGE        | HØGSKOLE_UNIVERSITET | 08.2021         | 06.2022         | 100              | 08.2021      | 200      | 200    |
      | 2            | INNVILGE        | HØGSKOLE_UNIVERSITET | 08.2021         | 06.2022         | 100              | 08.2021      | 300      | 300    |
  ...
  Scenario: Revurdert med ett nytt beløp i en annen måned
    ...
    Gitt følgende vedtak for skolepenger
      ...
      | 1            | INNVILGE        | HØGSKOLE_UNIVERSITET | 08.2021         | 06.2022         | 100              | 08.2021      | 200      | 200    |
      | 2            | INNVILGE        | HØGSKOLE_UNIVERSITET | 08.2021         | 06.2022         | 100              | 08.2021      | 200      | 200    |
      | 2            | INNVILGE        | HØGSKOLE_UNIVERSITET | 08.2021         | 06.2022         | 100              | 10.2021      | 300      | 300    |
