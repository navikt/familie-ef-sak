...
Egenskap: Andelhistorikk: Sanksjon av barnetilsyn
  ...
  Scenario: Sanksjon mellom 2 måneder
    ...
    Gitt følgende vedtak for barnetilsyn
      | Periodetype BT | Aktivitetstype BT | BehandlingId | Vedtaksresultat | Antall barn | Utgifter | Fra og med dato | Til og med dato |
      | ordinær        | i_arbeid          | 1            | INNVILGE        | 1           | 200      | 01.2021         | 03.2021         |
      | ordinær        | i_arbeid          | 2            | SANKSJONERE     | 0           | 0        | 02.2021         | 02.2021         |
