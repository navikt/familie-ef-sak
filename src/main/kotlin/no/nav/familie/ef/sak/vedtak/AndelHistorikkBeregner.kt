...
import no.nav.familie.ef.sak.vedtak.VedtakHistorikkBeregner.lagVedtaksperioderPerBehandling
...
object AndelHistorikkBeregner {
    ...
    private fun lagBehandlingHistorikkData(vedtaksliste: List<Vedtak>,
