...
import no.nav.familie.ef.sak.steg.StegType.FERDIGSTILLE_BEHANDLING
import no.nav.familie.ef.sak.steg.StegType.JOURNALFØR_BLANKETT
import no.nav.familie.ef.sak.steg.StegType.LAG_SAKSBEHANDLINGSBLANKETT
import no.nav.familie.ef.sak.steg.StegType.PUBLISER_VEDTAKSHENDELSE
import no.nav.familie.ef.sak.steg.StegType.SEND_TIL_BESLUTTER
