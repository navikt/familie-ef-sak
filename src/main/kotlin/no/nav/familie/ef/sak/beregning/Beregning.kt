...
fun finnGrunnbeløpsPerioder(fraOgMedDato: LocalDate, tilDato: LocalDate): List<Beløpsperiode> {
    return grunnbeløpsperioder
        ...
        .map {
            Beløpsperiode(
                periode = Periode(
                    fradato = maxOf(it.fraOgMedDato, fraOgMedDato),
...
val grunnbeløpsperioder: List<Grunnbeløp> =
    listOf(
        ...
        Grunnbeløp(
            ...
            tilOgMedDato = LocalDate.parse("2022-04-30"),
...
val nyesteGrunnbeløpGyldigFraOgMed = nyesteGrunnbeløp.fraOgMedDato
