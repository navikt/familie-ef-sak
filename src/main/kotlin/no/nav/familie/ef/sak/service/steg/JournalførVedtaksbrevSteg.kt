...
class JournalførVedtaksbrevSteg(private val taskRepository: TaskRepository,
                                private val vedtaksbrevIverksettingService: VedtaksbrevIverksettingService,
                                private val behandlingService: BehandlingService) : BehandlingSteg<Void?> {

    private val logger: Logger = LoggerFactory.getLogger(this::class.java)

    override fun utførSteg(behandling: Behandling, data: Void?) {
        val journalpostId = vedtaksbrevIverksettingService.journalførVedtaksbrev(behandling.id)
