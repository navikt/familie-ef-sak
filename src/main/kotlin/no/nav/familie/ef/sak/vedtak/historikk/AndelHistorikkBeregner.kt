...
object AndelHistorikkBeregner {
    ...
    private fun markerHistorikkEtterAndelSomFjernet(
        ...
        if (!vedtaksperiode.erSanksjon && andel.kildeBehandlingId == tilkjentYtelse.behandlingId) {
            historikk.filter { it.andel.periode.fom > andel.periode.fom }
        ...
        return andelFraHistorikk.finnEndringstype(andel, vedtaksperiode)?.let { endringType ->
            ...
            return if (endringType == EndringType.SPLITTET) {
                ...
                andelFraHistorikk.copy(
                    andel = andelHistorikk.copy(periode = andelHistorikk.periode.copy(fom = andel.periode.tom.plusDays(1))),
    ...
    private fun finnVedtaksperiodeForAndel(
        ...
        return vedtaksperioder.first { it.periode.inneholder(andel.periode.fomMåned) }
    }
    ...
    private fun AndelHistorikkHolder.erSanksjonMedSammePerioder(
        ...
        return vedtaksperiode.erSanksjon && tidligerePeriode.erSanksjon &&
            vedtaksperiode.periode == tidligereAndel.periode.toMånedsperiode()
    }
    ...
    private fun finnIndeksForNyAndel(
        ...
        val index = historikk.indexOfFirst { it.andel.periode.fom > andel.periode.fom }
