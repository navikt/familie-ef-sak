...
class SigrunClient(
    ...
    fun hentPensjonsgivendeInntekt(
        ...
        val uri =
            UriComponentsBuilder.fromUri(uri).pathSegment("api/sigrun/pensjonsgivendeinntekt")
    ...
    fun hentSummertSkattegrunnlag(
        ...
        val uri =
            UriComponentsBuilder.fromUri(uri).pathSegment("api/sigrun/summertskattegrunnlag")
                .queryParam("inntektsaar", inntektsår.toString())
                .build().toUri()
    ...
    fun hentBeregnetSkatt(
        ...
        val uri =
            UriComponentsBuilder.fromUri(uri).pathSegment("api/sigrun/beregnetskatt")
