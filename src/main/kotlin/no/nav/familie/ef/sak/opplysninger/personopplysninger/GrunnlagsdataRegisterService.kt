...
class GrunnlagsdataRegisterService(
    ...
    fun hentGrunnlagsdataFraRegister(
        ...
        println("tidligereVedtaksperioder.sak.øyeblikksbildeAvPerioderOgPeriodetype ${tidligereVedtaksperioder.sak?.øyeblikksbildeAvPerioderOgPeriodetype}") /*TODO SLETT*/
