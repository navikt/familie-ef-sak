...
class AktivitetArbeidRegel : Vilkårsregel(vilkårType = VilkårType.AKTIVITET_ARBEID,
    ...
    companion object {
        ...
        private val ER_I_ARBEID_ELLER_SYK =
                RegelSteg(regelId = RegelId.ER_I_ARBEID_ELLER_FORBIGÅENDE_SYKDOM,
