...
class ArbeidsforholdDto(val navArbeidsforholdId: Long? = null,
...
class ArbeidstakerDto(val type: String? = null,
                   val offentligIdent: String? = null,
                   val aktoerId: String? = null)

class ArbeidsgiverDto(val type: ArbeidsgiverType? = null,
                      val organisasjonsnummer: String? = null,
                      val offentligIdent: String? = null)

class AnsettelsesperiodeDto(val periode: Periode? = null,
                            val bruksperiode: Periode? = null)

class ArbeidsavtaleDto(val arbeidstidsordning: String? = null,
