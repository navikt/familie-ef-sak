...
class HistoriskPensjonController(val historiskPensjonService: HistoriskPensjonService) {
    ...
    fun hentFagsak(@PathVariable personIdent: String): Ressurs<HistoriskPensjonResponse> {
        return Ressurs.success(historiskPensjonService.hentHistoriskPensjon(personIdent))
    }
}
