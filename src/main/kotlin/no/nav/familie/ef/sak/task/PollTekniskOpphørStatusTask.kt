...
@TaskStepBeskrivelse(taskStepType = PollStatusFraIverksettTask.TYPE,
                     ...
                     beskrivelse = "Sjekker status på iverksetting av teknisk opphør.")

class PollTekniskOpphørStatusTask(private val stegService: StegService,
    ...
    companion object {
        ...
        const val TYPE = "pollerTekniskOpphørStatusFraIverksett"
    }
